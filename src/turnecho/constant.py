...
TURNECHO_PLUGIN_CACHE_DIRECTORY = Path("plugins") / "cache"
TURNECHO_MARKETPLACE_MANIFEST_PATH = Path(".agents") / "plugins" / "marketplace.json"
TURNECHO_RUNTIME_DIRECTORY = Path("turnecho") / "runtimes"
TURNECHO_RUNTIME_MARKER_FILE = ".turnecho-runtime.json"
